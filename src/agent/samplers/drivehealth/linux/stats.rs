...
pub static DRIVE_TEMPERATURE_WARNING_TIME: WindowedCounterGroup =
    WindowedCounterGroup::new(MAX_DRIVES);
...
pub static DRIVE_TEMPERATURE_CRITICAL_TIME: WindowedCounterGroup =
    WindowedCounterGroup::new(MAX_DRIVES);
...
pub static DRIVE_THERMAL_THROTTLE_TIME_1: WindowedCounterGroup =
    WindowedCounterGroup::new(MAX_DRIVES);
...
pub static DRIVE_THERMAL_THROTTLE_TIME_2: WindowedCounterGroup =
    WindowedCounterGroup::new(MAX_DRIVES);
...
pub static DRIVE_THERMAL_THROTTLE_TRANSITIONS_1: WindowedCounterGroup =
    WindowedCounterGroup::new(MAX_DRIVES);
...
pub static DRIVE_THERMAL_THROTTLE_TRANSITIONS_2: WindowedCounterGroup =
    WindowedCounterGroup::new(MAX_DRIVES);
